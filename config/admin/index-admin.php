  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      ...
      <ul class="nav navbar-nav">
           <li><a href="?page=funcionarios">Funcionários</a></li>
           <li><a href="?page=admin_quartos">Quartos</a></li>
           <li><a href="?page=clientes">Clientes</a></li>
           <li><a href="?page=contato">Contato</a></li>
      </ul>

      <ul class="nav navbar-nav navbar-right">
           <li><a href="../../public/index.php?page=principal">
               <span class="glyphicon glyphicon-log-out"></span> Voltar ao Site
           </a></li>
      </ul>
