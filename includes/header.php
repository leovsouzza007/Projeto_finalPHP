  ...
  <div class="bg-gray-900">
    <header class="absolute inset-x-0 top-0 z-50">
      <nav aria-label="Global" class="max-w-7xl mx-auto flex items-center justify-between p-6 lg:px-8">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          ...
          <a href="sobre_nos.php" class="text-sm/6 font-semibold text-white">Sobre Nós</a>
          <a href="companhia.php" class="text-sm/6 font-semibold text-white">Companhia PHP</a>
        </div>
          ...
          <div tabindex="0" class="fixed inset-0 focus:outline-none">
            <el-dialog-panel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
              <div class="flex items-center justify-between">
                <a href="#" class="-m-1.5 p-1.5">
                  <span class="sr-only">Your Company</span>
                  <img src="../assets/img/home.svg" alt="" class="h-8 w-auto" />
                </a>
              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-white/10">
                  <div class="space-y-2 py-6">
                    <a href="../forms/form_cadastro.php" class="text-sm/6 font-semibold text-white block">Cadastre-se</a>
                    <a href="sobre_nos.php" class="text-sm/6 font-semibold text-white block">Sobre Nós</a>
                    <a href="companhia.php" class="text-sm/6 font-semibold text-white block">Companhia PHP</a>
                  </div>

                  <div class="py-6">
                    <?php if (isset($_SESSION['id'])): ?>
                      <p class="px-3 py-2 text-base/7 font-medium text-white">Olá, <?php echo htmlspecialchars($_SESSION['nome'], ENT_QUOTES, 'UTF-8'); ?>!</p>
                      <a href="logout.php" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">Sair</a>
                    <?php else: ?>
                      <a href="../forms/form_login.php" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">Log in</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
    ...
    <main class="flex-grow relative overflow-hidden">
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56 px-6 lg:px-8">
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
              Descontos exclusivos para reservas online. <a href="#" class="font-semibold text-indigo-400"><span aria-hidden="true" class="absolute inset-0"></span>Confira <span aria-hidden="true">&rarr;</span></a>
            </div>
          </div>

          <div class="text-center">
            <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Experiência, Conforto e Sofisticação em Cada Estadia</h1>
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="../public/suites.php" class="text-sm/6 font-semibold text-white">Nossas Suítes <span aria-hidden="true">→</span></a>
            </div>
          </div>
        </div>
