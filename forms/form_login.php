    ...
    <div class="flex min-h-full flex-col justify-center items-center px-6 py-12 lg:px-8">
        ...
        <div class="w-full sm:max-w-[480px] bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-2xl shadow-indigo-500/20 border border-white/10 p-8 sm:p-10">
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-sm mb-10">
                ...
                <h2 class="mt-6 text-center text-2xl/9 font-bold tracking-tight text-white">Entre na sua conta</h2>
            </div>
            ...
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-400">
                    ...
                    <a href="form_cadastro.php" class="font-semibold text-indigo-400 hover:text-indigo-300 transition-colors">Crie uma conta</a>
                </p>
            </div>
        </div>
    </div>
